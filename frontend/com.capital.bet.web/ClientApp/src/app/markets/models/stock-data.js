...
for (var i_1 = 0; i_1 < stockData.length; i_1++) {
    if (stockData[i_1]['x'].getDate() !== date.getDate()) {
        stockData.splice(i_1, 0, {
            x: new Date(date.getTime()),
            open: stockData[i_1]['high'], low: stockData[i_1]['open'],
            close: stockData[i_1]['close'], high: stockData[i_1]['low'],
            volume: stockData[i_1]['volume']
        });
    }
...
for (var i_2 = 0; i_2 < exports.stockData1.length; i_2++) {
    if (exports.stockData1[i_2]['x'].getDate() !== date1.getDate()) {
        exports.stockData1.splice(i_2, 0, {
            x: new Date(date1.getTime()),
            open: exports.stockData1[i_2]['high'], low: exports.stockData1[i_2]['open'],
            close: exports.stockData1[i_2]['close'], high: exports.stockData1[i_2]['low'],
            volume: exports.stockData1[i_2]['volume']
        });
    }
...
for (var i_3 = 0; i_3 < stockData2.length; i_3++) {
    if (stockData2[i_3]['x'].getDate() !== date2.getDate()) {
        stockData2.splice(i_3, 0, {
            x: new Date(date2.getTime()),
            close: stockData2[i_3]['close']
        });
    }
...
for (var i_4 = 0; i_4 < stockData3.length; i_4++) {
    if (stockData3[i_4]['x'].getDate() !== date3.getDate()) {
        stockData3.splice(i_4, 0, {
            x: new Date(date3.getTime()),
            close: stockData3[i_4]['close']
        });
    }
...
for (var i_5 = 0; i_5 < stockData4.length; i_5++) {
    if (stockData4[i_5]['x'].getDate() !== date4.getDate()) {
        stockData4.splice(i_5, 0, {
            x: new Date(date4.getTime()),
            close: stockData4[i_5]['close']
        });
    }
