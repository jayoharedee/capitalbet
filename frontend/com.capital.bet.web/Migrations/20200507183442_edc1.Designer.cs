            ...
            modelBuilder.Entity("com.capital.bet.data.Models.Users.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "9b4a15f5-5e52-464e-9c11-37d707110cbb",
                            Name = "administrator",
                            NormalizedName = "ADMINISTRATOR",
                            CreatedDate = new DateTime(2020, 5, 7, 14, 34, 41, 701, DateTimeKind.Local).AddTicks(8015),
                            Description = "Administrative role used to run the system",
                            UpdatedDate = new DateTime(2020, 5, 7, 14, 34, 41, 704, DateTimeKind.Local).AddTicks(2899)
                        },
                        new
                        {
                            Id = "974be833-b074-4778-9b74-ca83e601dbbf",
                            ConcurrencyStamp = "8c90a9ef-6ab0-4d45-afd1-97e15640f0b6",
                            Name = "trade_moderator",
                            NormalizedName = "TRADE_MODERATOR",
                            CreatedDate = new DateTime(2020, 5, 7, 14, 34, 41, 704, DateTimeKind.Local).AddTicks(3520),
                            Description = "System Moderator role for users running projects",
                            UpdatedDate = new DateTime(2020, 5, 7, 14, 34, 41, 704, DateTimeKind.Local).AddTicks(3543)
                        },
                        new
                        {
                            Id = "818352ca-d178-407b-b8f4-48ac2ee6f3ac",
                            ConcurrencyStamp = "1720ec27-b480-4a90-b900-08205bf564d1",
                            Name = "tradder",
                            NormalizedName = "TRADDER",
                            CreatedDate = new DateTime(2020, 5, 7, 14, 34, 41, 704, DateTimeKind.Local).AddTicks(3564),
                            Description = "General user Account with minimal permissions.",
                            UpdatedDate = new DateTime(2020, 5, 7, 14, 34, 41, 704, DateTimeKind.Local).AddTicks(3568)
                        });
                });
