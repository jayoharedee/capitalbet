            ...
            modelBuilder.Entity("com.capital.bet.data.Models.Users.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "d573d707-a472-4c31-b793-52988a375b5d",
                            Name = "administrator",
                            NormalizedName = "ADMINISTRATOR",
                            CreatedDate = new DateTime(2020, 5, 4, 19, 47, 19, 528, DateTimeKind.Local).AddTicks(9475),
                            Description = "Administrative role used to run the system",
                            UpdatedDate = new DateTime(2020, 5, 4, 19, 47, 19, 531, DateTimeKind.Local).AddTicks(3673)
                        },
                        new
                        {
                            Id = "974be833-b074-4778-9b74-ca83e601dbbf",
                            ConcurrencyStamp = "c53eeec6-c5d5-4470-b309-530876d44c95",
                            Name = "trade_moderator",
                            NormalizedName = "TRADE_MODERATOR",
                            CreatedDate = new DateTime(2020, 5, 4, 19, 47, 19, 531, DateTimeKind.Local).AddTicks(4226),
                            Description = "System Moderator role for users running projects",
                            UpdatedDate = new DateTime(2020, 5, 4, 19, 47, 19, 531, DateTimeKind.Local).AddTicks(4247)
                        },
                        new
                        {
                            Id = "818352ca-d178-407b-b8f4-48ac2ee6f3ac",
                            ConcurrencyStamp = "36c9675d-c4c0-4d8e-90eb-bed30e6d998b",
                            Name = "tradder",
                            NormalizedName = "TRADDER",
                            CreatedDate = new DateTime(2020, 5, 4, 19, 47, 19, 531, DateTimeKind.Local).AddTicks(4267),
                            Description = "General user Account with minimal permissions.",
                            UpdatedDate = new DateTime(2020, 5, 4, 19, 47, 19, 531, DateTimeKind.Local).AddTicks(4271)
                        });
                });
