            ...
            modelBuilder.Entity("com.capital.bet.data.Models.Users.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "fbd97d19-9e74-4a57-9c1f-8788db0a10c2",
                            Name = "administrator",
                            NormalizedName = "ADMINISTRATOR",
                            CreatedDate = new DateTime(2020, 5, 4, 15, 34, 13, 744, DateTimeKind.Local).AddTicks(5556),
                            Description = "Administrative role used to run the system",
                            UpdatedDate = new DateTime(2020, 5, 4, 15, 34, 13, 747, DateTimeKind.Local).AddTicks(3158)
                        },
                        new
                        {
                            Id = "974be833-b074-4778-9b74-ca83e601dbbf",
                            ConcurrencyStamp = "789c11bc-f6e2-4c33-85a1-a9b676192134",
                            Name = "trade_moderator",
                            NormalizedName = "TRADE_MODERATOR",
                            CreatedDate = new DateTime(2020, 5, 4, 15, 34, 13, 747, DateTimeKind.Local).AddTicks(3879),
                            Description = "System Moderator role for users running projects",
                            UpdatedDate = new DateTime(2020, 5, 4, 15, 34, 13, 747, DateTimeKind.Local).AddTicks(3902)
                        },
                        new
                        {
                            Id = "818352ca-d178-407b-b8f4-48ac2ee6f3ac",
                            ConcurrencyStamp = "856c560a-43b0-42f5-982d-5be5d2522f2c",
                            Name = "tradder",
                            NormalizedName = "TRADDER",
                            CreatedDate = new DateTime(2020, 5, 4, 15, 34, 13, 747, DateTimeKind.Local).AddTicks(3923),
                            Description = "General user Account with minimal permissions.",
                            UpdatedDate = new DateTime(2020, 5, 4, 15, 34, 13, 747, DateTimeKind.Local).AddTicks(3927)
                        });
                });
